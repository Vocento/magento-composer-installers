 ...
 */
final class MagentoProjectInstaller extends MagentoInstaller
{
    /**
     * MagentoProjectInstaller constructor.
    ...
    public function __construct(PackageInterface $package = null, Composer $composer = null, IOInterface $io = null)
    {
        ...
        $configExcludedFiles = $this->composer->getConfig()->get('exclude-magento-project-files');
